...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">只想学好做网站</h1>
				<p class="tagline">所以不装逼</p>
				<p><a class="btn btn-default btn-lg" type="button">MORE INFO</a> <a class="btn btn-warning btn-lg" type="button">DOWNLOAD NOW</a></p>
			</div>
		</div>
	</header>
	<!-- /Header -->
